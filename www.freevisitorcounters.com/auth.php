...
ctrHref=trimTrailingSlash('http://www.versicherungen.at/krankenzusatzversicherung/'.trim());ctrHref2=trimTrailingSlash('http://www.versicherungen.at/krankenzusatzversicherung/'.trim());eInDoc=function(e){while(e=e.parentNode){if(e==document){return true;}}
...
if(linktext!='Zusatzversicherung'){linkfound=false;}
break;}}
if(linkfound==false){var div=document.createElement('div');div.id='error_560fe734be05081e68dfd87d306c1f16bf488219';div.innerHTML='<a href="https://www.freevisitorcounters.com/en/home/countercode/hashid/?id=560fe734be05081e68dfd87d306c1f16bf488219">Counter Error: Do not change the code. Click here to show the correct code!</a>';if(document.getElementById('counterimg')!=null){document.getElementById('counterimg').parentNode.insertBefore(div,document.getElementById('counterimg').nextSibling);}else{document.body.appendChild(div);}
